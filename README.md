...
This is an unofficial Python API for Bamboo HR. It's been forked from [smeggingsmeggari](https://github.com/smeggingsmegger/PyBambooHR) for Addepar. So far it is focusing on managing employee information but you can pretty much do anything you want with a little python.
